...
<div class="content">
    ...
    <div class="con-body">
        <div class="step-con">
            <!--步骤-->
            <div class="step-box ">
                <span class="step-num  bg-img s1_on fl"></span> <span class="step-num  bg-img s2_on fl"></span> <span class="step-num  bg-img s3_off fl"></span>
            </div>
        </div>
        <div class="clear"></div>
        <!--数据库信息-->
        <form action='<?php echo url('setup3') ?>' method='get' onsubmit="return check_form();">
            <div class="Test2">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name='db_address' value="<?= ip(); ?>"/></td>
                        <td>数据库服务器地址，一般为<?= ip();?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name='db_pre' value='im_'/></td>
            ...
            <div class="bline Test2 admin_block">
                <table>
                    ...
                    <tr>
                        <td class="text2-td1">超管账号：</td>
                        <td><input type="text" name="admin_user"/></td>
                        <td>超管账号最少4位</td>
                    </tr>
                    <tr>
                        <td class="text2-td1">超管密码：</td>
            ...
            <!--按钮--> 
            <div class="btn">
                <a class="m195 agree-btn fl" href="<?php echo url('setup1') ?>">上一步</a> <input type="submit" disabled="disabled" class="agree-btn disabled fl next" value="安装系统"/>
            </div>
