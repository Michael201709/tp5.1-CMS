<?php
    ...
    function get_http_s()
    {
        ...
        $top = 'http';
        if ($_SERVER['SERVER_PORT'] == 443 || $_SERVER['HTTPS'] == 1 || $_SERVER['HTTPS'] == 'on' || $_SERVER['HTTP_X_CLIENT_SCHEME'] == 'https' || ($_SERVER['HTTP_VIA'] && strpos(strtolower($_SERVER['HTTP_VIA']), 'baidu-cdn-') !== FALSE)) {
            $top = 'https';
        }
