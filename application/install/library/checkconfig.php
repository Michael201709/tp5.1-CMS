...
{
    //安装需求
    private $php_version = '7.1.0+';
    private $must_extension = ['gd', 'xml', 'session', 'iconv', 'bcmath', 'gd'];
    private $recom_extension = ['zip', 'curl'];
    private $writeable_dir = ['runtime', 'public/uploads'];
    private
        $php_ini = ['safe_mode' => ['type' => '=', 'value' => false], 'allow_url_fopen' => ['type' => '=', 'value' => '1'], 'memory_limit' => ['type' => '>', 'value' => '12M']];
    private $php_function = ['unlink', 'mkdir', 'filemtime', 'fopen', 'fwrite', 'fclose', 'session_start', 'chmod'];
    //记录检查结果
